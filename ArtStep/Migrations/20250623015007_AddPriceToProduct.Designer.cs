...
<<<<<<<< HEAD:ArtStep/Migrations/20250616191535_InitialCreate.Designer.cs
    [Migration("20250616191535_InitialCreate")]
    partial class InitialCreate
========
    [Migration("20250623015007_AddPriceToProduct")]
    partial class AddPriceToProduct
>>>>>>>> origin/nhat:ArtStep/Migrations/20250623015007_AddPriceToProduct.Designer.cs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ArtStep.Data.User", b =>
                {
                    ...
                    b.Property<string>("SentFeedbacksFeedbackId")
                        .HasColumnType("varchar(255)");
                    ...
                    b.HasIndex("SentFeedbacksFeedbackId");
            ...
            modelBuilder.Entity("ArtStep.Data.User", b =>
                {
                    b.HasOne("ArtStep.Data.Feedback", "SentFeedbacks")
                        .WithMany()
                        .HasForeignKey("SentFeedbacksFeedbackId");
