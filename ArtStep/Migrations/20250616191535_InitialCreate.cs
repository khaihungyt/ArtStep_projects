        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SentFeedbacksFeedbackId = table.Column<string>(type: "varchar(255)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_User_feedback_SentFeedbacksFeedbackId",
                        column: x => x.SentFeedbacksFeedbackId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_User_SentFeedbacksFeedbackId",
                table: "User",
                column: "SentFeedbacksFeedbackId");
